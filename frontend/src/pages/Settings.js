  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8 animate-fade-in-up">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Manage your account preferences and financial configurations.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass-panel p-6 flex flex-col items-center text-center">
            ...
            <span className="mt-4 px-4 py-1 bg-brand-primary/20 text-brand-primary border border-brand-primary/30 rounded-full text-xs font-bold tracking-wider uppercase">Pro Plan</span>
          </div>
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSave} className="glass-panel p-6 sm:p-8 space-y-8">
            <div className="space-y-6">
              <h3 className="text-lg font-bold text-white border-b border-white/10 pb-2">Financial Preferences</h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-300">Monthly Budget Goal</label>
                  <input 
                    type="number" 
                    name="monthlyBudget"
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-bold text-white border-b border-white/10 pb-2">Notifications & App</h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-300">Daily Reminder Time</label>
                  <input 
                    type="time" 
                    name="reminderTime"
              ...
              <div className="flex items-center justify-between p-4 border border-white/5 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
                <div>
                  ...
                  <p className="text-slate-400 text-xs mt-0.5">Receive weekly reports and warnings.</p>
                </div>
                <button 
                  type="button"
                  onClick={() => setSettings(p => ({...p, emailAlerts: !p.emailAlerts}))}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${settings.emailAlerts ? 'bg-brand-primary' : 'bg-slate-600'}`}
                >
              ...
              <div className="flex items-center justify-between p-4 border border-white/5 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
                <div>
                  <h4 className="text-white font-medium">Dark Mode Appearance</h4>
                  <p className="text-slate-400 text-xs mt-0.5">FinTrack requires dark mode natively for SaaS elegance.</p>
                </div>
                <button 
                  type="button"
                  disabled
                  className="relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none bg-brand-primary opacity-50 cursor-not-allowed"
                >
